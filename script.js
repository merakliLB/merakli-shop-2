        ...
        productsContainer.innerHTML = products.map(product => `
            <div class="product">
                ...
                <div class="product-info">
                    ...
                    <button onclick="addToCart(${product.id})" class="space-button">🛒 أضف إلى السلة</button>
                </div>
            </div>
        `).join('');
    }
        ...
        <li class="cart-item">
            ...
            <div class="cart-item-details">
                ...
                <div class="quantity-controls">
                    <button onclick="increaseQuantity(${item.id})" class="space-button">+</button>
                    <button onclick="decreaseQuantity(${item.id})" class="space-button">-</button>
                    <button class="remove-btn space-button" onclick="removeFromCart(${item.id})">❌ إزالة</button>
                </div>
            </div>
        </li>
    `).join('');
...
function translateToEnglish() {
    document.title = 'Space Shopping Cart';
...
function translateToArabic() {
    document.title = 'سلة التسوق الفضائية';
    document.querySelectorAll('nav a').forEach(a => {
